...
function App() {
  return (
    <div className="container box-border p-4 m-0 bg-white w-screen h-screen border border-red-600">
      <section>
      ...
      <section className="flex flex-col justify-center border border-red-500 text-center">
        <div className="mx-auto w-1/2 border border-green-500 ">
          ...
          <h1 className="w-full font-bold text-7xl">1.4k+</h1>
          <p>Communities Formed</p>
        </div>
        <div className="mx-auto w-1/2 border border-green-500">
          <img src={message} alt="message" />
          <h1 className="w-full font-bold text-7xl">2.7m+</h1>
          <p>Messages Sent</p>
        </div>
      </section>
    </div>
