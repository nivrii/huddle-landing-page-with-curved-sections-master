      ...
      <footer className="bg-bgFooter -mt-1">
        ...
        <div>
          <div className="flex text-white">
            <img src={message} alt="message" className="fill-white stroke-white"/>
            <h1>Huddle</h1>
          </div>
        </div>
        <p className="text-xs">
      Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank">Frontend Mentor</a>. 
      Coded by <a href="https://github.com/nivrii/huddle-landing-page-with-curved-sections-master>Your Name Here</a>.
    </p>
      </footer>
    </div>
  );
