...
function App() {
  return (
    <div className=" box-border m-0 bg-white w-screen min-h-screen">
      ...
      <footer className="bg-bgFooter -mt-1 pb-2">
        ...
        <p className="text-xs text-center text-attribution">
          Challenge by{" "}
          <a href="https://www.frontendmentor.io?ref=challenge" target="_blank" className="text-Light-pink underline decoration-solid decoration-4">
            Frontend Mentor
          </a>
          . Coded by{" "}
          <a href="https://github.com/nivrii/huddle-landing-page-with-curved-sections-master" className="underline decoration-solid decoration-4 text-Light-red">
            NiVrIi
          </a>
          .
        </p>
