      ...
      <footer className="bg-bgFooter -mt-1 pb-4">
        ...
        <div className="flex flex-col">
          <div className="flex border border-white">
            <img src={phone} alt="Phone" className="mx-4 my-2 align-middle" />
            <p className="m-2 text-white ">Phone: +1-455-535-7654</p>
          </div>
          <div className="flex border border-white">
            <img src={gmail} alt="Gmail" className="mx-4 my-2 align-middle" />
            <p className="m-2 text-white ">flimzniv9@gmail.com</p>
          </div>
        </div>
