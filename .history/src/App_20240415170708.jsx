...
import react-iconset from "react-icons/bs";
...
function App() {
  return (
    <div className=" box-border m-0 bg-white w-screen min-h-screen">
      ...
      <footer className="bg-bgFooter -mt-1 p-4">
        ...
        <div className="flex flex-col space-y-2 p-4">
          <div className="flex space-x-4">
            <img src={phone} alt="Phone" className="h-4 w-6 my-auto" />
            <p className="my-auto text-white ">Phone: +1-455-535-7654</p>
          </div>
          <div className="flex space-x-4">
            <img src={gmail} alt="Gmail" className="h-4 w-6 my-auto" />
