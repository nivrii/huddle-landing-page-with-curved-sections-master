...
function App() {
  return (
    <div className="container box-border m-0 bg-white w-screen min-h-screen border border-red-600">
      ...
      <section className="flex flex-col space-y-12 bg-sectionBG px-8 py-12">
      ...
      <section className="flex flex-col space-y-12 my-28 px-8">
        <img src={conversation} alt="conversations" className="px-4 text-center" />
