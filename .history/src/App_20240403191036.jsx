...
function App() {
  return (
    <div className="container box-border m-0 bg-white w-screen min-h-screen border border-red-600">
      ...
      <img src={sectionTop1M} alt="top-top" />
      ...
      <img src={sectionBottom1M} alt="top-bottom" />
      ...
      <img src={sectionTop2M} alt="bottom-top" />
      ...
      <img src={sectionBottom2M} alt="bottom-bottom" />
      <section className="flex flex-col space-y-8 my-12 px-8">
        <h1 className="text-center">Ready To Build Your Community?</h1>
        <input type="button"  value="Get Started For Free" className="outline-none bg-Pink text-white w-fit py-2 px-8"/>
      </section>
    </div>
  );
}
