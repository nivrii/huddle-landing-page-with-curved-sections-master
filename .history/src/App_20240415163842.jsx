      ...
      <footer className="bg-bgFooter -mt-1 pb-4">
        ...
        <div className="flex flex-col">
          <div className="flex border border-white">
            <img src={phone} alt="Phone" className="m-4 align-middle" />
            <p className="inline-block text-white align-middle">Phone: +1-455-535-7654</p>
          </div>
          <div className="flex border border-white">
            <img src={gmail} alt="Gmail" className="m-4 align-middle" />
            <p className="inline-block text-white align-middle">flimzniv9@gmail.com</p>
          </div>
        </div>
